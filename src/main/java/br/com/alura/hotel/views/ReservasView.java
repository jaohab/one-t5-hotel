...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		super("Reserva");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/main/java/br/com/alura/hotel/res/aH-40px.png")));
		...
		txtDataE.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/main/java/br/com/alura/hotel/res/icon-reservas.png")));
		...
		txtDataS.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/main/java/br/com/alura/hotel/res/icon-reservas.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/main/java/br/com/alura/hotel/res/Ha-100px.png")));
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/main/java/br/com/alura/hotel/res/reservas-img-3.png")));
